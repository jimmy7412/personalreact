        ...
        return(
            <div>
                <Container className={'mb-5'}>
                    ...
                    <Row className={'mt-5'}>
                        <Col sm={'3'} className={'mt-5'}><img className={'img-fluid'} src={SOC} alt='CatLoaf'/></Col>
                        <Col sm={'9'} className={'mt-5'}>
                            <AProject name='Gatsby Site'
                                      whatIs={'A website that will display static stuff, it may become a personal news site/Blog'}
